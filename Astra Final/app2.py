...
class New_Toplevel_1:
    def __init__(self, top=None):
        ...
        def commandword():
            print(v.get())
            commandword = v.get()
            process2.calculate(commandword)
            # app1report.create_New_Toplevel_1(Tk(),commandword)
            os.startfile(os.getcwd() + "\\data2\\report_" + str(commandword) + ".dat")
        ...
        self.Radiobutton7.configure(value=7)
        ...
        self.Radiobutton8.configure(value=8)
        ...
        self.Radiobutton9.configure(value=9)
        ...
        self.Radiobutton10.configure(value=10)
